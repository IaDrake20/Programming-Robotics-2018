...
import org.usfirst.frc.team3062.robot.commands.ShiftLeft;
import org.usfirst.frc.team3062.robot.commands.ShiftRight;
...
//	10: Right Joystick
	...
	JoystickButton pickUpBlock = new JoystickButton( buttonStick, 1 ); //A Button
	JoystickButton shootBlock = new JoystickButton( buttonStick, 2 ); //B Button
	...
	//JoystickButton shiftRight = new JoystickButton( driverStick, 8 ); //Start button
	//JoystickButton shiftLeft = new JoystickButton( driverStick, 7 ); //Select button
	...
	//ShiftRight shr = new ShiftRight();
	//ShiftLeft shl = new ShiftLeft();
...
//	TestPneumatics testp = new TestPneumatics();
	...
	public OI() {
		//shiftRight.whenPressed(shr);
		//shiftLeft.whenPressed(shl);
		lowerElevator.whenPressed(ld);
		raiseElevator.whenPressed(lmu);
			
			
		elevatorStop.whenPressed(ls);
		pickUpBlock.whenPressed(pub); 
		shootBlock.whenPressed(sb);
